...
build() {
    ...
    if [ ! -d "${CURRENT_DIR}/output/${ARCH_PREFIX}" ]; then
        mkdir ${CURRENT_DIR}/output/${ARCH_PREFIX}
    fi

    PREFIX=${CURRENT_DIR}/output/${ARCH_PREFIX}

    OPENSSL_LIB_DIR=${CURRENT_DIR}/third_party/output/openssl/${ARCH_PREFIX}
